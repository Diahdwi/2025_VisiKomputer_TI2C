...
def classify_gesture(hand):
    # hand["lmList"] berisi 21 titik (x,y,z) saat flipType=True
    lm = hand["lmList"]
    ...
    # Rata-rata jarak ke pergelangan tangan (untuk Rock/Paper)
    r_mean = np.mean([
    ...
    # Thumbs Up: ibu jari lebih tinggi (y lebih kecil) + cukup jauh dari wrist
